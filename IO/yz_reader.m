function ar = yz_reader(varname, seq, varargin)
...
% Usage:
%   Entire field:
%     slab = yz_reader(varname, seq);
%   2D field (portion):
%     slab = yz_reader(varname, seq, xrange, zrange);
%
% Where:
%   - varname is the file to read
%   - seq is the sequence number of the output
%   - yrange and zrange are the ranges of the
...
%     ie. slab = xz_reader(varname, 1, 1, zrange);
