%% The user needs to define ii the output number at which to make a picture
clc; clearvars; close all;
spinsgrid2d
%addpath("C:\Users\samha\OneDrive - Newcastle University\COVID19\DigiFlow_dfi_read")
...
vort = spins_reader_new('vorty', ii);
vortrange = 6;
...
clf
betterplots
colormap(brighten(darkjet, .5))

subplot(2,1,1)
pcolor(x,z,vort),shading flat; caxis([-1 1]*vortrange)
hold on

quiver(xi, zi, ui, wi, 'k');
