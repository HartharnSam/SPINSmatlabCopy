function xg = generate_xgrid(phys_size,num_size,varargin)
% generate_xgrid  Generates xgrid for use with SPINS data
%
%    Assumptions:
...
%
%  Usage in 3D:
%    xg = generate_xgrid([Lx Ly Lz], [Nx Ny Nz], z_bc_type);
%  Usage in 2D:
%    xg = generate_xgrid([Lx Lz], [Nx Nz], z_bc_type);
%
%  Inputs:
