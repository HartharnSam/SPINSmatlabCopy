...
if Ny == 1
    xg = generate_xgrid([Lx Lz],[Nx Nz_new],params.type_z);
    zg = generate_zgrid([Lx Lz],[Nx Nz_new],params.type_z);
else
    xg = generate_xgrid([Lx Ly Lz],[Nx Ny Nz_new],params.type_z);
    yg = generate_ygrid([Lx Ly Lz],[Nx Ny Nz_new],params.type_z);
    zg = generate_zgrid([Lx Ly Lz],[Nx Ny Nz_new],params.type_z);
end
